...
public:
  QIniSettings(const QString &organization, const QString &application = QString(), QObject *parent = nullptr ):
#ifdef Q_OS_WIN
  ...
  QIniSettings(const QString &fileName, Format format, QObject *parent = nullptr )
